      ...
      return (
        <>
          ...
          <XmlBlock name="process">
            ...
            <V3If condition={ctx.hasExistingMapping}>
              ...
              <V3If condition={userChoice === 'refresh'}>
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`}</pre>
            ...
            <V3If condition={!verification.allExist}>
              <p><b>Verification issues found:</b></p>

              <V3If condition={verification.missingDocs.length > 0}>
                <p>Missing documents: {verification.missingDocs.join(', ')}</p>
              </V3If>

              <V3If condition={verification.emptyDocs.length > 0}>
              ...
              <V3If condition={userChoice === 'retry'}>
            ...
            <V3If condition={ctx.commitPlanningDocs}>
