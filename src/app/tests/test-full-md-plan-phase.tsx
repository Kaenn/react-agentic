...
export default (
  <Command name="gsd:plan-phase" description="Create detailed execution plan for a phase (PLAN.md) with verification loop"
...
```markdown
<XmlBlock name="planning_context">
...
```markdown
<XmlBlock name="verification_context">
...
```markdown
<XmlBlock name="revision_context">
