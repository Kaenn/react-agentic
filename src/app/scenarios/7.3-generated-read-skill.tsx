  ...
  return (
    ...
    >
      ...
      <p>
        ...
        Ensure <code>/test-state.init</code> has been run to create the state table.
      </p>

      <h2>Test Setup</h2>
      <p>First, initialize the state and populate it with test data.</p>
      <ol>
        <li>Run <code>/test-state.init</code> if not already done</li>
        <li>Set up known test values using <code>/test-state.write</code></li>
      </ol>
      ...
      <p>Invoke the read skill with a field argument to get a single field.</p>
      ...
      <p>Read another specific field to confirm field filtering works consistently.</p>
      ...
      <p>Read the description field which contains a longer string value.</p>
      ...
      <p>Read the timestamp field to verify datetime handling.</p>
