...
Uses SpawnAgent: `grep "import.*SpawnAgent" src/composites/SpawnAgentWithRetry.tsx`
Uses Loop/If/Break: `grep -E "import.*(Loop|If|Break)" src/composites/SpawnAgentWithRetry.tsx`
  </verify>
