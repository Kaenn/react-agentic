...
files_modified:
  ...
  - src/app/scenarios/2.3-heading-hierarchy.tsx
...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/app/scenarios/9.1-orchestrating-workflow.tsx"
      provides: "Workflow test with List for objectives and Table for status"
      contains: ["<Table", "<List"]
  key_links:
...
Output: 5 updated scenario files demonstrating Table and List component usage
</objective>
