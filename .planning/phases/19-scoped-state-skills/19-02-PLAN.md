...
must_haves:
  truths:
    - "State component with ReleasesState interface produces 4 skill files (init, read, write, delete)"
    - "Generated init skill creates SQLite table with columns matching interface fields (lastVersion->TEXT, bumpType->TEXT)"
