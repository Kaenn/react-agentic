...
must_haves:
  truths:
    - "ProviderTemplate interface defines generateInit, generateRead, generateWrite, generateDelete, generateOperation methods"
    - "SQLiteProvider implements all ProviderTemplate methods"
    - "Generated skills use sqlite3 CLI with JSON output"
    - "SQL escaping helper prevents injection"
