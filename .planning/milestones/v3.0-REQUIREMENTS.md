# Requirements Archive: v3.0 Primitive/Composite Architecture
...
**Shipped:** 24 of 25 v3.0 requirements
**Adjusted:** None
**Dropped:** None
**Deferred:** 1 (DOC-02 — migration guide deferred as no migration needed pre-production)
